 ...
 */
 function getLocale(): SupportLanguage {
  const result = (localStorage.getItem("current__locale") as SupportLanguage) || defaultLanguage
  return result
}
 ...
 * @returns IntlShape
 */
const getIntl = (locale?: SupportLanguage, changeIntl?: boolean) => {
 ...
 */
const setIntl = (locale: SupportLanguage) => {
